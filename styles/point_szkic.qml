...
<qgis hasScaleBasedVisibilityFlag="0" readOnly="0" labelsEnabled="0" version="3.10.14-A Coruña" minScale="1e+08" simplifyMaxScale="1" simplifyLocal="1" maxScale="0" simplifyDrawingHints="0" simplifyDrawingTol="1" styleCategories="AllStyleCategories" simplifyAlgorithm="0">
  <flags>
    ...
    <symbols>
      <symbol type="marker" alpha="1" name="0" force_rhr="0" clip_to_extent="1">
        ...
        <layer enabled="1" class="SimpleMarker" locked="0" pass="0">
          ...
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="138,73,0,255"/>
          <prop k="outline_style" v="solid"/>
  ...
  <customproperties>
    <property key="dualview/previewExpressions" value="&quot;wyr_id&quot;"/>
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory height="15" diagramOrientation="Up" penWidth="0" scaleDependency="Area" backgroundColor="#ffffff" scaleBasedVisibility="0" labelPlacementMethod="XHeight" sizeType="MM" penColor="#000000" width="15" sizeScale="3x:0,0,0,0,0,0" lineSizeType="MM" minimumSize="0" rotationOffset="270" minScaleDenominator="0" lineSizeScale="3x:0,0,0,0,0,0" backgroundAlpha="255" opacity="1" barWidth="5" enabled="0" maxScaleDenominator="1e+08" penAlpha="255">
