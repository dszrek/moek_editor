...
<qgis hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" maxScale="0" labelsEnabled="0" simplifyDrawingHints="1" readOnly="0" simplifyLocal="1" version="3.10.11-A Coruña" simplifyAlgorithm="0" simplifyDrawingTol="1" styleCategories="AllStyleCategories" minScale="1e+08">
  ...
  <renderer-v2 attr="b_done" type="categorizedSymbol" symbollevels="0" enableorderby="0" forceraster="0">
    <categories>
      <category label="SPRAWDZONE" render="true" value="true" symbol="0"/>
      <category label="NIESPRAWDZONE" render="true" value="false" symbol="1"/>
    </categories>
    <symbols>
      <symbol clip_to_extent="1" name="0" type="fill" alpha="1" force_rhr="0">
        <layer enabled="1" pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="line_color" v="0,170,255,77"/>
          ...
          <prop k="width_map_unit_scale" v="3x:3000,0,0,0,0,0"/>
