...
class LayerManager:
    ...
    def __init__(self, dlg):
        ...
        self.lyrs = [
            ...
            {"source": "wms", "name": "ISOK", "root": False, "parent": "basemaps", "visible": False, "uri": 'crs=EPSG:2180&dpiMode=0&featureCount=10&format=image/jpeg&layers=ISOK_Cien&styles=default&tileMatrixSet=EPSG:2180&url=https://mapy.geoportal.gov.pl/wss/service/PZGIK/NMT/GRID1/WMTS/ShadedRelief?service%3DWMTS%26request%3DgetCapabilities'},
