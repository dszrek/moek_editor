    ...
    def __setattr__(self, attr, val):
        ...
        if attr == "flag":
            ...
            if val:
                ...
                if not self.wyr_data:
                    print("Błąd: Nie odnaleziono rekordu wyrobiska w bazie danych.")
                    return
                ...
                self.dlg.wyr_panel.status_selector.case = self.wyr_data[2]
                ...
                # Przycisk kosza (delbox) pokazujemy wyłącznie dla wszystkich wyrobisk nowych (b_new = True):
                dlg.wyr_panel.delbox.setVisible(b_new)
                # Aktualizacja etykiety powierzchni wyrobiska:
