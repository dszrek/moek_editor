...
<qgis hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" maxScale="0" labelsEnabled="0" simplifyDrawingHints="1" readOnly="0" simplifyLocal="1" version="3.10.11-A Coruña" simplifyAlgorithm="0" simplifyDrawingTol="1" styleCategories="AllStyleCategories" minScale="1e+08">
  ...
  <renderer-v2 type="singleSymbol" symbollevels="0" enableorderby="0" forceraster="0">
    <symbols>
      <symbol clip_to_extent="1" name="0" type="fill" alpha="1" force_rhr="0">
        <layer enabled="0" pass="0" class="MarkerLine" locked="0">
                ...
                <Option type="Map">
                  ...
                  <Option name="properties" type="Map">
                    <Option name="char" type="Map">
                      ...
                      <Option name="expression" type="QString" value="to_string( @geometry_part_num )  +  '_'  +   to_string( @geometry_point_num)"/>
  ...
  <aliases>
    <alias field="part" index="0" name=""/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <defaults>
    <default field="part" applyOnUpdate="0" expression=""/>
  </defaults>
  <constraints>
    <constraint exp_strength="0" field="part" unique_strength="0" constraints="0" notnull_strength="0"/>
  </constraints>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" width="-1" name="part" type="field"/>
    </columns>
